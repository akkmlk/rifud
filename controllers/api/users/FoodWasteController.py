...
from models.food_waste import get_food_waste_filter, get_all_food_waste, get_food_waste_resto_filter, get_one_food_waste, put_update_food_waste, del_food_waste
